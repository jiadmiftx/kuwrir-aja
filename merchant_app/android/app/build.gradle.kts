...
android {
    ...
    defaultConfig {
        applicationId = "com.kuwrir.merchant"
    ...
    // only lists Firebase clients for com.kuwrir.merchant, so an
    ...
    productFlavors {
        create("dev") {
            ...
            resValue("string", "app_name", "Cocourir Merchant (Dev)")
        }
        create("prod") {
            dimension = "environment"
            resValue("string", "app_name", "Cocourir Merchant")
        }
    }
