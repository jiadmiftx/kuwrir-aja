...
class _WalletScreenState extends State<WalletScreen>
          ...
          child: Column(
            ...
            children: [
              ...
              if (error != null) ...[
                ...
                Text(
                  error!,
                  style: TextStyle(color: KuwrirColors.error, fontSize: 13),
                ),
              ],
  ...
  Future<void> _openBankAccountSheet(Map<String, dynamic>? existing) async {
    final numberCtrl = TextEditingController(
      text: existing?['account_number'] as String? ?? '',
    );
    final nameCtrl = TextEditingController(
      text: existing?['account_name'] as String? ?? '',
    );
  ...
  Future<void> _openWithdrawSheet(double balance) async {
    ...
    final accountNumberCtrl = TextEditingController(
      text: saved?['account_number'] as String? ?? '',
    );
    final accountNameCtrl = TextEditingController(
      text: saved?['account_name'] as String? ?? '',
    );
        ...
        builder: (sheetContext, setSheetState) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Saldo tersedia: Rp ${_fmt(balance)}',
                ...
                child: FilledButton(
                  onPressed: submitting
                      ...
                      : () async {
                          ...
                          if (amount > balance) {
                            setSheetState(
                              () => error = 'Jumlah melebihi saldo tersedia',
                            );
                            return;
                          }
    ...
    return BlocBuilder<CustomerWalletCubit, CustomerWalletState>(
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Wallet Kuwrir'),
            backgroundColor: KuwrirColors.background,
          ),
        ...
        children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        onPressed: s.wallet.balance > 0
                            ? () => _openWithdrawSheet(s.wallet.balance)
                            : null,
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => _openBankAccountSheet(
                    context.read<CustomerWalletCubit>().bankAccount,
                  ),
          ...
          if (s.transactions.isEmpty)
            ...
            for (final tx in s.transactions)
              _TransactionTile(tx: tx, fmt: _fmt),
        ],
      ),
    );
  }
